...
SwiftDeploy started as a small idea: what if a deployment tool could take one plain manifest and generate the boring, fragile infrastructure files around it?

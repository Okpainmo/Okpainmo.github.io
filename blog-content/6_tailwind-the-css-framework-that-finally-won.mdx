...
postThumbnailUrl: '/blog/post-banners/post-banner_6.png'
...
at Zed Labs."
postTags: ['tailwindcss', 'css', 'frontend-development', 'ui-design', 'web-development', 'styling']
...
![post banner](/blog/post-banners/post-banner_6.png)

You must have heard of <WrapperLink href='https://tailwindcss.com' type="text">TailwindCSS</WrapperLink>, the big, awesome
thing that have finally become a standard in the Cascading Style Sheet(CSS) world.
...
<WrapperLink href="https://tailwindcss.com">
  ...
  page](/blog/_6/06_img-1.png) _Image: a screenshot showing a section from the
...
<WrapperLink href="https://getbootstrap.com">
  ...
  page](/blog/_6/06_img-2.png) _Image: a screenshot showing a section from the
  bootstrap website landing page._
</WrapperLink>

Bootstrap was awesome - it saved lives in its prime, Its grid system(back then) was truly revolutionary.
But one major complaint kept hitting it hard - it produced interfaces that looked
very similar. This flaw is because Bootstrap is not just a CSS library or framework. It is a complete(HTML,
...
With Bootstrap, developers seemed to get locked in, barely seeing the need to customize further, thereby
...
likely never bothered about back then - I guess due to my experience level.
...
<WrapperLink href="https://sass-lang.com/">
  ...
  page](/blog/_6/06_img-3.png) _Image: a screenshot showing a section from the
  sass website landing page._
</WrapperLink>
...
![a screenshot showing sass mixin declarations](/blog/_6/06_img-11.png)
_Image: a screenshot showing sass mixin declarations._

![a screenshot showing mixin import and use](/blog/_6/06_img-13.png)
...
![a screenshot showing sass imports](/blog/_6/06_img-12.png)
...
> Writing this article, I must confess to this feeling I'm having. I think to say that I honestly miss writing Sass 🤓.
>
...
<WrapperLink href="https://gulpjs.com">
  ...
  page](/blog/_6/06_img-9.png) _Image: a screenshot showing a section from the
  gulp website landing page._
</WrapperLink>
...
content={`
    ...
    ✅ Register the buildStyles task properly
...
<CodeBlock language="shell" content={`gulp watch`} />
...
Tailwind is by far the best CSS framework I have ever used. It was a game-changer for me, and I believe it has been for many others.
...
![a screenshot showing the free-tier section on the AWS website](/blog/_6/06_img-4.png)
_Image: tailwind css intellisense helping with viewing the css content of a tailwind utility class._

![a screenshot showing the free-tier section on the AWS website](/blog/_6/06_img-8.png)
_Image: tailwind css intellisense helping with viewing the css content of a tailwind utility class._
...
<CodeBlock
  ...
  content={`
    ...
    function PrimaryButton({ children }) {
      return (
        <button className='px-[22px] py-12 bg-blue-500 text-gray-100
...
<WrapperLink href="https://www.creative-tim.com/twcomponents/cheatsheet">
  ...
  website](/blog/_6/06_img-10.png) _Image: a screenshot showing the tailwind
  cheatsheet section on the creative tim website._
</WrapperLink>
...
<WrapperLink href="https://nerdcave.com/tailwind-cheat-sheet">
  ...
  ](/blog/_6/06_img-5.png) _Image: a screenshot showing the tailwind cheatsheet
  section on the nerdcave website._
</WrapperLink>
...
<WrapperLink href="https://www.nativewind.dev/">
  ![a screenshot showing a section from the nativewind website landing
  page](/blog/_6/06_img-6.png) _Image: a screenshot showing a section from the
...
2. **Desktop Applications**: Frameworks like [Electron](https://www.electronjs.org) and [Tauri](https://v2.tauri.app) can use
   Tailwind directly since they're web-based. Even though I am yet to try them out.

3. While I'm not very certain, my research showed the use of tailwind CSS in **Flutter**, with libraries

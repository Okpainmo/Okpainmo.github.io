---
postTitle: 'Complete NodeJs Back-end Deployment On AWS EC2'
...
postThumbnailUrl: "/blog/post-banners/post-banner_9.png"
...
at Zed Labs."
postTags: ['nodejs', 'express', 'aws', 'ec2', 'route-53', 'dns', 'nginx', 'ssl', 'devops', 'deployment']
subCategories: ['backend-development']
postSlug: "complete-nodejs-back-end-deployment-on-aws-ec2"
authorSocials:
...
![post banner](/blog/post-banners/post-banner_9.png)
...
<GitHubEmbed owner="Okpainmo" repo="aws-ec2-node-express-deployment-project" />
...
![(a post image sharing more information)](/blog/_9/9_img-71.png)
...
![(a post image sharing more information)](/blog/_9/9_img-67.png)
![(a post image sharing more information)](/blog/_9/9_img-66.png)
...
![(a post image sharing more information)](/blog/_9/9_img-65.png)

- Perform necessary system update/upgrades.

<CodeBlock language="bash" content={`sudo apt update && sudo apt upgrade -y`} />

![(a post image sharing more information)](/blog/_9/9_img-64.png)
...
<CodeBlock language="bash" content={`nvm --version`} />

- Install latest Node LTS version.

<CodeBlock language="bash" content={`nvm install --lts`} />

- Making sure to use the newly installed LTS NodeJs version.

<CodeBlock language="bash" content={`nvm use --lts`} />

- Verify NodeJs.

<CodeBlock language="bash" content={`node -v`} />

![(a post image sharing more information)](/blog/_9/9_img-58.png)

- Verify NPM.

<CodeBlock language="bash" content={`npm -v`} />
...
<CodeBlock language="bash" content={`ls`} />

### 4. Make all project dependency installations, and run the API server.

- Make dependency installations.

<CodeBlock language="bash" content={`npm install`} />

![(a post image sharing more information)](/blog/_9/9_img-54.png)

- Run the project server.

<CodeBlock language="bash" content={`npm run dev`} />

![(a post image sharing more information)](/blog/_9/9_img-53.png)
...
![(a post image sharing more information)](/blog/_9/9_img-52.png)
...
![(a post image sharing more information)](/blog/_9/9_img-50.png)
...
![(a post image sharing more information)](/blog/_9/9_img-49.png)
...
![(a post image sharing more information)](/blog/_9/9_img-13.png)
...
![(a post image sharing more information)](/blog/_9/9_img-14.png)
...
![(a post image sharing more information)](/blog/_9/9_img-41.png)
...
![(a post image sharing more information)](/blog/_9/9_img-34.png)
...
![(a post image sharing more information)](/blog/_9/9_img-27.png)
...
![(a post image sharing more information)](/blog/_9/9_img-28.png)
...
![(a post image sharing more information)](/blog/_9/9_img-18.png)
...
![(a post image sharing more information)](/blog/_9/9_img-21.png)
...
![(a post image sharing more information)](/blog/_9/9_img-20.png)

You should then see a success message that looks similar to the one below.

![(a post image sharing more information)](/blog/_9/9_img-17.png)
...
![(a post image sharing more information)](/blog/_9/9_img-15.png)
...
![(a post image sharing more information)](/blog/_9/9_img-5.png)
...
![(a post image sharing more information)](/blog/_9/9_img-72.png)
...
![(a post image sharing more information)](/blog/_9/9_img-8.png)
...
![(a post image sharing more information)](/blog/_9/9_img-6.png)
...
![(a post image sharing more information)](/blog/_9/9_img-3.png)

![(a post image sharing more information)](/blog/_9/9_img-2.png)

![(a post image sharing more information)](/blog/_9/9_img-1.png)
